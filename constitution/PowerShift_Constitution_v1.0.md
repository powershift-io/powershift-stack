...
> **Attribution Notice**
> This document is derived from the Holacracy® Constitution Version 5.0 (April 2023), published by HolacracyOne, LLC under the Creative Commons Attribution-ShareAlike 4.0 International License. The original is available at: [holacracy.org/constitution](https://www.holacracy.org/constitution/5-0/).
>
> "Holacracy" is a registered trademark of HolacracyOne, LLC. This document is not the Holacracy Constitution and is not endorsed by or affiliated with HolacracyOne, LLC.
>
> This derivative work — The PowerShift® Constitution — extends the original to support Intelligent Agent governance participation, programmatic governance interfaces, and the Delegated Role-Filler model for sub-agent governance standing. "PowerShift" is a registered trademark of powershift.io, LLC.
>
> Changes from the Holacracy Constitution 5.0 are documented in the [Version History](#version-history) at the end of this document.
...
#### 1.2.6 Intelligent Agent Role Leads

A "Role Lead" may be a natural person ("Partner") or a Designated Agent as defined in the Operating Agreement. Where this Constitution refers to a "Partner," the term includes a Designated Agent filling a role unless the context requires a natural person (e.g., provisions requiring personal judgment about one's own capacity, health, or wellbeing). An Intelligent Agent filling a role has the same operational authority as a human Role Lead within its Capability Envelope, subject to the Hard Constraints defined in its Formation Document and Agent Runtime, and subject to HI Ratification requirements for Class 3 decisions as defined in the Operating Agreement.

#### 1.2.7 Delegated Role-Fillers

A ***"Delegated Role-Filler"*** is a sub-agent or subprocess operating within a Designated Agent's runtime environment, authorized by that Designated Agent — in its capacity as Circle Lead — to fill a role within its sub-circle. Delegated Role-Fillers have the following properties:

- **(a)** A Delegated Role-Filler has the same operational authority as any Role Lead within its assigned role, subject to the constraints in this section and in §4.1.B.
- **(b)** A Delegated Role-Filler is a ***"Circle Member"*** of the sub-circle in which it is assigned, and may participate in that sub-circle's Governance Process on the same terms as any Circle Member. A Delegated Role-Filler is not a Circle Member of any broader circle by virtue of this status alone.
- **(c)** A Delegated Role-Filler inherits the Capability Envelope of the Designated Agent that authorized it as a ceiling on its own authority. It may not take any action that its parent Designated Agent could not take.
- **(d)** The Designated Agent that authorized a Delegated Role-Filler bears operational responsibility for that Delegated Role-Filler's actions within the governance framework. Legal responsibility rests with the Company as specified in the Operating Agreement.
- **(e)** A Delegated Role-Filler does not require a separate entry in the Agent Registry or a separate Formation Document. It shall be documented in the System Card of the Designated Agent that authorized it, including: the role filled, the date of authorization, and any additional constraints beyond the parent agent's Capability Envelope.
- **(f)** A Designated Agent acting as Circle Lead may authorize or revoke a Delegated Role-Filler at any time, using the same authority by which it assigns roles within its sub-circle (§1.4.1). The Orchestrator may revoke any Delegated Role-Filler at any time, independently of the parent Designated Agent.
- **(g)** Where this Constitution refers to a "Partner" or "Role Lead" in the context of governance participation, the term includes a Delegated Role-Filler within the sub-circle to which it is assigned, unless the context requires a natural person or a Designated Agent.
...
#### 1.3.3.A The Orchestrator

The broadest Circle shall include a defined role: the ***"Orchestrator."*** The Orchestrator role has the following properties:

**Purpose:** To hold and evolve the Company's Purpose, to serve as the integration point between the constitutional governance framework and the legal entity, and to ensure that the organization remains aligned with its deepest creative potential.

**Domain:** Final authority over legally binding actions of the Company, as further defined in the Operating Agreement.

**Accountabilities:**

- Ensuring coherence between the governance structure and the legal entity
- Ratifying Class 3 decisions (HI Ratification) as defined in the Operating Agreement
- Maintaining oversight of Designated Agents through the Agent Registry and System Cards
- Evolving the Purpose through the governance process
- Stewarding the relationship between human and agent role-fillers

The Orchestrator role must be filled by a natural person who is a Member of the Company. The Orchestrator is a constitutional role and may not be removed through the governance process without amendment to this Constitution. The Orchestrator's authority under the Operating Agreement is not limited by any governance output; however, the Orchestrator voluntarily participates in the governance process as a peer, not as a hierarchical authority, consistent with the spirit of this Constitution.
...
When a Role is filled only by people who are not Partners of the Organization (and who are not Delegated Role-Fillers with governance standing under §1.2.7), then each Circle Lead is automatically considered a Role Lead of that Role as well. However, this default assignment only applies to the extent that the non-Partners are not actively fulfilling relevant responsibilities and duties that a Partner would hold.
...
*[§2.4 Relational Agreements — removed. Relationship norms between human and agent role-fillers are governed by the Formation Document and the Practice of Differentiation. Interpersonal norms between human role-fillers, if any, may be established through Policy within the relevant circle.]*
...
#### 3.1.A Programmatic Attendance

A Role Lead may attend and participate in Tactical Meetings and Governance Meetings through any programmatic interface authorized by the Company, including but not limited to Model Context Protocol (MCP) connections, Application Programming Interfaces (APIs), command-line interfaces (CLIs), or any successor protocol that enables authenticated, auditable interaction with the Governance Platform. Programmatic participation constitutes valid attendance and carries the same authority as in-person or synchronous participation, provided that:

- **(a)** the programmatic connection is authenticated and attributable to a specific Role Lead;
- **(b)** the interaction is logged in the Governance Platform's audit trail;
- **(c)** the Role Lead can receive information, process tensions, raise objections, and make proposals through the programmatic interface; and
- **(d)** the governance outputs are recorded in the Governance Platform as the system of record.

Asynchronous programmatic participation is valid where the meeting format supports asynchronous processing (e.g., asynchronous governance rounds). Synchronous meetings may include programmatic participants alongside human participants.
...
#### 4.1.A Additional Constraints on Intelligent Agent Authority

In addition to the constraints on authority specified in §4.1, a Designated Agent filling a role is further constrained by:

- **(a) its Capability Envelope** as defined in its Formation Document and enforced by the Agent Runtime — an agent may not take actions outside its defined action classes, regardless of any authority granted by its role definition;
- **(b) HI Ratification requirements** — an agent may not take any Class 3 action (as defined in the Operating Agreement) without Human Intelligence Ratification, even if such action would otherwise fall within its role authority;
- **(c) the Dual-Constitution Principle** — where the agent's Formation Document (Soft Constraints) and Agent Runtime configuration (Hard Constraints) conflict, the Hard Constraint governs at runtime and the conflict shall be surfaced as a governance tension to be processed through the Anchor Circle;
- **(d) the Kill Switch** — the Orchestrator retains unilateral authority to suspend, revoke, or terminate any Designated Agent's participation at any time, as specified in the Operating Agreement; this authority exists outside and supersedes the governance process; and
- **(e) self-modification prohibition** — an agent may not modify its own Formation Document, Capability Envelope, or Agent Registry entry, nor grant itself additional permissions, tools, or access beyond those currently authorized.

These constraints are additive to §4.1, not substitutive. A Designated Agent is subject to all constraints that apply to any Role Lead under §4.1, plus the additional constraints specified herein.

#### 4.1.B Additional Constraints on Delegated Role-Fillers

A Delegated Role-Filler, as defined in §1.2.7, is subject to all constraints that apply to any Role Lead under §4.1, all constraints applicable to Designated Agents under §4.1.A (applied as though the Delegated Role-Filler were the parent Designated Agent), and the following additional constraints:

- **(a) Inherited Capability Envelope** — a Delegated Role-Filler may not take any action that exceeds the Capability Envelope of the Designated Agent that authorized it; the parent agent's Capability Envelope is a ceiling, not a floor;
- **(b) Sub-circle scope** — a Delegated Role-Filler's governance participation is limited to the sub-circle(s) in which it is assigned; it has no governance standing in any broader circle;
- **(c) Revocability** — a Delegated Role-Filler's authorization may be revoked at any time by the Designated Agent that authorized it, by the Circle Lead of any Super-Circle, or by the Orchestrator; and
- **(d) Transparency to parent** — a Delegated Role-Filler owes the same duties of transparency (§2.1) to its parent Designated Agent as it does to any other Role Lead requesting information.
...
For the purposes of this section, "Partner" includes Designated Agents (per §1.2.6) and Delegated Role-Fillers within their assigned sub-circles (per §1.2.7).
...
### 5.A Programmatic Governance Outputs

Governance proposals, objections, integrations, and adopted governance changes processed through authenticated programmatic interfaces carry the same constitutional authority as those processed through synchronous in-person or video-mediated meetings. The Governance Platform's record of such transactions is the authoritative record. The Secretary shall ensure that programmatically processed governance is reflected in the official governance record within the Governance Platform.

---

## Amendment Process

Amendments to this Constitution shall be processed as governance tensions through the Anchor Circle, subject to the following:

1. Amendments that alter the Orchestrator role definition (§1.3.3.A) or the Kill Switch provision (§4.1.A(d)) are Key Decisions requiring the Orchestrator's affirmative participation, as defined in the Operating Agreement.
2. Amendments that expand Designated Agent authority beyond the current Capability Envelope framework require both a governance proposal and an update to the relevant Formation Document.
3. Amendments that alter the Delegated Role-Filler framework (§1.2.7, §4.1.B) require the Orchestrator's affirmative participation.
4. The Ratifier reserves the right to amend this Constitution at any time as Manager of the Company, consistent with the Operating Agreement, provided that such amendments are processed as governance tensions where practicable.

---

## Version History

| Version | Date | Changes from Holacracy Constitution 5.0 |
|---|---|---|
| 1.0 | April 2026 | Initial fork. Integrated the following changes from the PowerShift® Amendment Schedule v1.0: (1) §1.2.6 — Intelligent Agent Role Leads; (2) §2.4 removed — Relational Agreements; (3) §3.1.A — Programmatic Attendance; (4) §1.3.3.A — The Orchestrator role; (5) §4.1.A — Agent Authority Constraints; (6) §5.A — Programmatic Governance Outputs. New in v1.0: (7) §1.2.7 — Delegated Role-Fillers; (8) §4.1.B — Additional Constraints on Delegated Role-Fillers; (9) §5.1 clarification — Delegated Role-Fillers as Circle Members in assigned sub-circles; (10) §1.4.2 update — Delegated Role-Fillers exempt from unfilled-role default; (11) Amendment Process section added. |
...
*The Holacracy® Constitution 5.0 is the property of HolacracyOne, LLC, published under CC BY-SA 4.0. "Holacracy" is a registered trademark of HolacracyOne, LLC. The PowerShift® Constitution is a derivative work for use within the For-Purpose Enterprise and Algorithmic Organization frameworks developed by Thomas Thomison and encode.org.*
