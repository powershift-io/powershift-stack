...
- Add public open-vs-organization-specific boundary guidance.
- Add Public Stack Steward operating model for agency-maximizing repo stewardship.
- Add contributor and review surfaces.
...
- PowerShift® Primer v1.0.
- PowerShift® Constitution v1.0 and v1.1.
- Composition-aware profiles.
- Formation and system-card templates.
- Legal adoption pathways.
- Operating Agreement Template v1.0.
- Ratification Agreement v1.0.
- Solo Orchestrator example.
- Initial explanatory documentation.
